...
#define FW_MILESTONE_INDEX_IB 0x1701
...
/* 78 */ { 0, 2, PT_FAC, 	NO_UNIT,		4, 1<<17,	PARAM_RMS_STOPPED_FACTOR,STR_UNKNOWN,			convertRMSFactor}, 	
//=======Motion Status Group
/* 79 */ { 0, 2, PT_FMTR, 	VEL_TICKS_S,	2, 1<<2,	PARAM_RMS_STOPPED_SPEED,STR_UNKNOWN,			convertSpdLim}, 
...
/* 321*/ { 0, 1, PT_FMTR, 	VEL_TICKS_S,	2, 1<<2,	PARAM_INDEX_DETECT_SPEED,STR_DRV_SPEED_LIM,		convertSpdLim}, 
...
/* 523*/ { 0, 2, PT_FAC, 	TIME_MSEC,		2, 1,		PARAM_IB_TC_SLOW,		STR_P_IB_FILT_TC,		convertIBRMSSlowtc}, 
...
/* 580*/ { 0, 1, PT_NV_RW, 	NO_UNIT,		2, 1U << 15,PARAM_IB_TRIP_USER,			STR_P_IB_TRIP,			convertAmpsRMS },
};
#undef UDSZ
...
*/
	...
	{ NVR,  CPM_P_DRV_IB_TRIP_USER,			8,		FW_MILESTONE_INDEX_IB, 0, 1 },
	// AC_GREEN Settings
	...
	{ NVR,  CPM_P_DRV_IB_TRIP_USER,			12.5,	FW_MILESTONE_INDEX_IB, 0, 2 },
